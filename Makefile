...
deploy:
	...
	ssh deploy@${HOST} -p ${PORT} 'cd site_${BUILD_NUMBER} && docker compose -f docker-compose-production.yml run api-php-cli php bin/migrations.php --ansi migrations:migrate --no-interaction'
